...
$INPUT      ID TIME AMT  DROP  CMT CMTT DV WT EGFR AGE COV1 COV2 EVID OCC GROUP TRT SEQ BLQ 
...
$THETA ;; all are log of THETA
  ...
  (-5,-0.53064,5)		; THETA(12) K42
  (-5,-0.89632,6) 		 ; THETA(13) LN(K24)
  (-5,-2,5)		; THETA(14) LN(ALAG) REFERENCE 
  (-5,-2,5) 		; THETA(15) LN(ALAG) test
  ; NO D1
  ;;no eta on ka

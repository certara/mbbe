...
$THETA 	; all are log of THETA
  ...
  -0.1		; THETA(18) CL~COV1 


  1		; THETA(19) V~WT estimated 
 
$TABLE ID TIME GROUP TRT DV IPRED EVID PERIOD SEQ NOPRINT FILE=DATA.TXT NOHEADER NOAPPEND 


;; Phenotype 
;; OrderedDict([('ADVAN', 1), ('BOVV', 1), ('BOVCL', 0), ('KAETA', 0), ('ALAG1', 1), ('DURATION1', 0), ('COVARVCL', 1), ('CL~WT', 1), ('CL~AGE', 1), ('CL~EGFR', 1), ('CL~COV1', 1), ('CL~COV2', 0), ('V~WT', 1), ('V~AGE', 0), ('V~COV1', 0), ('V~COV2', 0)])
;; Genotype 

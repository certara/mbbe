...
$THETA
 0.175071 		; THETA(1) LN(CL)
 -1.0075 		; THETA(2) ADD ERROR
 -2.99024		; THETA(3) PROP ERROR
 -2.00443		; THETA(4) LN(BSV) CL
 -2.08778 		; THETA(5) LN(BSV) V2
 -1.00147 		; THETA(6) LN(KA) reference
 -0.198698 		; THETA(7) LN(KA) test
 -0.0975912 		; THETA(8) LN(F1) TEST
 0.0799426 		; THETA(9) init for V2
 (-5,-3.01025,5) 	; THETA(10) LN(K32)
 (-5,-3.00019,5) 	; THETA(11) LN(K23)
 (-5,-0.500981,5) 	; THETA(12) LN(ALAG) REFERENCE
 (-5,-0.500295,5) 	; THETA(13) LN(ALAG) test
 (-10,-5.13363,5) 	; THETA(14) BOVV
 0.770473 		; THETA(15) CL~WT
 0.506631 		; THETA(16) CL~AGE
 1.04091 		; THETA(17) CL~EGFR
 0.973776 		; THETA(18) V~WT estimated
 0.0509107 		; THETA(19) V~COV2

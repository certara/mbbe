...
# source_nmfe <- file.path(system.file(package = "mbbe"), "tests","test_files", "check_requirements","nmfetest.bat")
  ...
  source_nmfe <- file.path("u:","fda","mbbe","tests" ,"test_files", "check_requirements","nmfetest.bat")
 # source_models <- file.path(system.file(package = "mbbe"),"tests", "test_files", "copy_files")
  ...
  data_file <- file.path(source_models,"tests", "test_files","data_seq.csv")
...
#                   model2[5])
  ...
  source_sim_data <-    file.path("u:","fda","mbbe","tests" ,"test_files","data_seq.csv")

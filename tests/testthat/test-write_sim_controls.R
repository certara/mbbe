test_that("get_parameters works", {
  ...
  souce_dir <- file.path("u:","fda","mbbe","tests", "test_files", "get_parms")
...
#            file.path(run_dir,"model1","1"))
  ...
  file.copy(file.path("u:","fda","mbbe","tests", "test_files", "get_parms", "model1", "1","bsSamp1_1.lst"),
            file.path(run_dir,"model1","1"))
  file.copy(file.path("u:","fda","mbbe","tests", "test_files", "get_parms", "model1", "1","bsSamp1_1.ext"),
            file.path(run_dir,"model1","1"))
  file.copy(file.path("u:","fda","mbbe","tests", "test_files", "get_parms", "model1", "1","bsSamp1_1.xml"),
            file.path(run_dir,"model1","1"))
  ...
  file.copy(file.path("u:","fda","mbbe","tests", "test_files", "get_parms", "model2", "1","bsSamp2_1.lst"),
            file.path(run_dir,"model1","1"))
  file.copy(file.path("u:","fda","mbbe","tests", "test_files", "get_parms", "model2", "1","bsSamp2_1.ext"),
            file.path(run_dir,"model1","1"))
  file.copy(file.path("u:","fda","mbbe","tests", "test_files", "get_parms", "model2", "1","bsSamp2_1.xml"),
            file.path(run_dir,"model1","1"))

...
First is the data set for the bootstrap analysis. Second is the data set for the Monte Carlo Simulation. Note that these can be the same. The analysis data set is specified on the \$DATA record in the NONMEM control files for the bootstrap. The 2nd is specified as the

simulation_data_path

options. Note again, they can be the same file.
